...
model_executions as (
    ...
    select
      ...
      , sum(models.exeuction_time) as execution_time
...
seed_executions as (
    ...
    select
      ...
      , sum(seeds.exeuction_time) as execution_time
...
snapshot_executions as (
    ...
    select
      ...
      , sum(snapshots.exeuction_time) as execution_time
...
test_executions as (
    ...
    select
      ...
      , sum(tests.exeuction_time) as execution_time
