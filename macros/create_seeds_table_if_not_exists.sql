...
{% macro snowflake__get_create_seeds_table_if_not_exists_statement_test(database_name, schema_name, table_name) -%}
...
{% macro default__get_create_seeds_table_if_not_exists_statement_test(database_name, schema_name, table_name) -%}
    create table {{database_name}}.{{schema_name}}.{{table_name}} (
        command_invocation_id STRING,
        node_id STRING,
